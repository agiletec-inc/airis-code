...
import { Config } from '@airiscode/core';
...
vi.mock('@airiscode/core', async () => {
  const actual = await vi.importActual('@airiscode/core');
  return {
    ...actual,
...
describe('Configuration Integration Tests', () => {
  ...
  beforeEach(() => {
    tempDir = fs.mkdtempSync(path.join(tmpdir(), 'airiscode-test-'));

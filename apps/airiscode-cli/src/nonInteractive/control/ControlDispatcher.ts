...
export class ControlDispatcher implements IPendingRequestRegistry {
  ...
  private pendingIncomingRequests: Map<string, PendingIncomingRequest> = new Map();
  private pendingOutgoingRequests: Map<string, PendingOutgoingRequest> = new Map();
   ...
   */
  private sendSuccessResponse(requestId: string, response: Record<string, unknown>): void {

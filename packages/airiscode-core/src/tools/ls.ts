...
export interface LSToolParams {
  ...
  /**
   * Whether to respect .gitignore and .airiscodeigenore patterns (optional, defaults to true)
   */
  file_filtering_options?: {
    respect_git_ignore?: boolean;
    respect_airiscode_ignore?: boolean;
  };
}
  ...
  async execute(_signal: AbortSignal): Promise<ToolResult> {
    try {
      ...
      const relativePaths = files.map((file) =>
        path.relative(this.config.getTargetDir(), path.join(this.params.path, file)),
      );
      ...
      const { filteredPaths, gitIgnoredCount, qwenIgnoredCount } =
        fileDiscovery.filterFilesWithReport(relativePaths, {
          ...
          respectAiriscodeIgnore:
            this.params.file_filtering_options?.respect_airiscode_ignore ??
            this.config.getFileFilteringOptions().respectAiriscodeIgnore ??
    ...
    super(
      ...
      Kind.Search,
      {
        properties: {
          ...
          file_filtering_options: {
            description:
              "Optional: Whether to respect ignore patterns from .gitignore or .airiscodeigenore",
            type: "object",
            properties: {
              respect_git_ignore: {
                description:
              ...
              respect_airiscode_ignore: {
                description:
                  "Optional: Whether to respect .airiscodeigenore patterns when listing files. Defaults to true.",
                type: "boolean",
              },
            },
          },

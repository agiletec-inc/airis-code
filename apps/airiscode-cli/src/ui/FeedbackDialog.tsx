...
export const FeedbackDialog: React.FC = () => {
  ...
  return (
    <Box flexDirection="column" marginY={1}>
      ...
      <Box marginTop={1}>
        <Text color="cyan">{FEEDBACK_OPTION_KEYS[FEEDBACK_OPTIONS.GOOD]}: </Text>
        <Text>{t("Good")}</Text>
        <Text> </Text>
        <Text color="cyan">{FEEDBACK_OPTION_KEYS[FEEDBACK_OPTIONS.BAD]}: </Text>
        <Text>{t("Bad")}</Text>
        <Text> </Text>
        <Text color="cyan">{FEEDBACK_OPTION_KEYS[FEEDBACK_OPTIONS.FINE]}: </Text>
        <Text>{t("Fine")}</Text>
        <Text> </Text>
        <Text color="cyan">{FEEDBACK_OPTION_KEYS[FEEDBACK_OPTIONS.DISMISS]}: </Text>
        <Text>{t("Dismiss")}</Text>
        <Text> </Text>
      </Box>
    </Box>

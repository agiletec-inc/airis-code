...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes("/.pnpm/global")) {
      const updateCommand = "pnpm add -g @airiscode/ui-gemini@latest";
      return {
    ...
    if (realPath.includes("/.yarn/global")) {
      const updateCommand = "yarn global add @airiscode/ui-gemini@latest";
      return {
    ...
    if (realPath.includes("/.bun/bin")) {
      const updateCommand = "bun add -g @airiscode/ui-gemini@latest";
      return {
    ...
    // Assume global npm
    const updateCommand = "npm install -g @airiscode/ui-gemini@latest";
    return {

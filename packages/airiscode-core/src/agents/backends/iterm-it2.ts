...
async function tryInstallIt2(command: string, args: string[]): Promise<boolean> {
...
export async function itermRunCommand(sessionId: string, command: string): Promise<void> {
...
export async function itermSendText(sessionId: string, text: string): Promise<void> {

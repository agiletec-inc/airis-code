...
class AskUserQuestionToolInvocation extends BaseToolInvocation<AskUserQuestionParams, ToolResult> {
...
export class AskUserQuestionTool extends BaseDeclarativeTool<AskUserQuestionParams, ToolResult> {
  ...
  constructor(private readonly config: Config) {
    super(
      ...
      Kind.Think,
      askUserQuestionToolSchemaData.parametersJsonSchema as Record<string, unknown>,
    );
  }

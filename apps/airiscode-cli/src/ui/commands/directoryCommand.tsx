...
export function getDirPathCompletions(partialArg: string): string[] {
  ...
  try {
    return fs
      ...
      .filter((e) => e.isDirectory() && e.name.startsWith(namePrefix) && !e.name.startsWith("."))
        ...
        try {
          if (config.shouldLoadMemoryFromIncludeDirectories()) {
            const { memoryContent, fileCount } = await loadServerHierarchicalMemory(
              ...
              [...config.getWorkspaceContext().getDirectories(), ...pathsToAdd],
          ...
          addItem(
            {
              ...
              text: t(
                "Successfully added AIRISCODE.md files from the following directories if there are:\n- {{directories}}",
                {

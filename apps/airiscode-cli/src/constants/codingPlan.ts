 ...
 */
export function generateCodingPlanTemplate(region: CodingPlanRegion): CodingPlanTemplate {
 ...
 */
export function getRegionFromBaseUrl(baseUrl: string | undefined): CodingPlanRegion | null {

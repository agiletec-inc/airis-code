    ...
    while (attempt < maxAttempts) {
        ...
        try {
            ...
            if (authType === AuthType.QWEN_OAUTH && isQwenQuotaExceededError(error)) {
                throw new Error(`Qwen OAuth quota exceeded: Your free daily quota has been reached.\n\n` +
                    `To continue using AIRIS Code without waiting, upgrade to the Alibaba Cloud Coding Plan:\n` +

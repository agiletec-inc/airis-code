...
vi.mock('../../core/contentGenerator.js', async (importOriginal) => {
    ...
    const { DEFAULT_AIRISCODE_MODEL } = await import('../../config/models.js');
    return {
        ...actual,
    ...
    describe('AgentHeadless', () => {
        ...
        describe('execute - Initialization and Prompting', () => {
            ...
            it('should validate that systemPrompt and initialMessages are mutually exclusive', async () => {
                ...
                await expect(agent.execute(context)).rejects.toThrow('PromptConfig cannot have both `systemPrompt` and `initialMessages` defined.');

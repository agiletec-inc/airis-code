...
export default {
  ...
  'Approval mode set to "{{mode}}"': 'Modo de aprovação definido como "{{mode}}"',
  "View or change the language setting": "Ver ou alterar a configuração de idioma",
  ...
  "Create a new subagent with guided setup.": "Criar um novo subagente com configuração guiada.",
  ...
  "(built-in)": "(integrado)",
  "(overridden by project level agent)": "(substituído por agente de nível de projeto)",
  ...
  "Description is over {{length}} characters": "A descrição tem mais de {{length}} caracteres",
  ...
  "Step {{n}}: Choose Generation Method": "Etapa {{n}}: Escolher Método de Geração",
  ...
  "Generating subagent configuration...": "Gerando configuração do subagente...",
  ...
  "e.g., You are an expert code reviewer...": "ex: Você é um revisor de código especialista...",
  ...
  "Load Memory From Include Directories": "Carregar Memória de Diretórios Incluídos",
  ...
  "Tool Output Truncation Threshold": "Limite de Truncamento de Saída de Ferramenta",
  "Tool Output Truncation Lines": "Linhas de Truncamento de Saída de Ferramenta",
  ...
  "Show model-specific usage statistics.": "Mostrar estatísticas de uso específicas do modelo.",
  "Show tool-specific usage statistics.": "Mostrar estatísticas de uso específicas da ferramenta.",
  ...
  "Show all directories in the workspace": "Mostrar todos os diretórios no workspace",
  ...
  'Installing extension from "{{source}}"...': 'Instalando extensão de "{{source}}"...',
  'Extension "{{name}}" installed successfully.': 'Extensão "{{name}}" instalada com sucesso.',
  ...
  'Uninstalling extension "{{name}}"...': 'Desinstalando extensão "{{name}}"...',
  'Extension "{{name}}" uninstalled successfully.': 'Extensão "{{name}}" desinstalada com sucesso.',
  ...
  'Installation cancelled for "{{name}}".': 'Instalação cancelada para "{{name}}".',
  ...
  "Enable auto-update for this extension.": "Ativar atualização automática para esta extensão.",
  ...
  'Extension "{{name}}" successfully uninstalled.': 'Extensão "{{name}}" desinstalada com sucesso.',
  ...
  "The scope to disable the extenison in.": "O escopo para desativar a extensão.",
  ...
  'Extension "{{name}}" is already up to date.': 'A extensão "{{name}}" já está atualizada.',
  ...
  "List all settings for an extension.": "Listar todas as configurações de uma extensão.",
  ...
  // ============================================================================
  "No plugins available in this marketplace.": "Nenhum plugin disponível neste marketplace.",
  ...
  "Press Space, Enter, or Escape to dismiss": "Pressione Espaço, Enter ou Escape para dispensar",
  ...
  "Enter to select · Esc to cancel": "Enter para selecionar · Esc para cancelar",
  // Hooks - Detail Step
  ...
  "When a permission dialog is displayed": "Quando um diálogo de permissão é exibido",
  ...
  "stdout shown in transcript mode (ctrl+o)": "stdout exibido no modo transcrição (ctrl+o)",
  ...
  "Export session to markdown format": "Exportar a sessão para o formato Markdown",
  ...
  // Commands - Language
  // ============================================================================
  "Invalid language. Available: {{options}}": "Idioma inválido. Disponíveis: {{options}}",
  ...
  "Current LLM output language: {{lang}}": "Idioma atual da saída do LLM: {{lang}}",
  ...
  "LLM output language set to {{lang}}": "Idioma de saída do LLM definido para {{lang}}",
  ...
  "Approval mode changed to: {{mode}}": "Modo de aprovação alterado para: {{mode}}",
  ...
  "Failed to save approval mode: {{error}}": "Falha ao salvar modo de aprovação: {{error}}",
  "Failed to change approval mode: {{error}}": "Falha ao alterar modo de aprovação: {{error}}",
  "Apply to current session only (temporary)": "Aplicar apenas à sessão atual (temporário)",
  "Persist for this project/workspace": "Persistir para este projeto/workspace",
  "Persist for this user on this machine": "Persistir para este usuário nesta máquina",
  ...
  "Automatically approve file edits": "Aprovar automaticamente edições de arquivos",
  ...
  // Commands - Memory
  // ============================================================================
  "Commands for interacting with memory.": "Comandos para interagir com a memória.",
  "Show the current memory contents.": "Mostrar os conteúdos atuais da memória.",
  "Show project-level memory contents.": "Mostrar conteúdos da memória de nível de projeto.",
  "Show global memory contents.": "Mostrar conteúdos da memória global.",
  "Add content to project-level memory.": "Adicionar conteúdo à memória de nível de projeto.",
  ...
  "Global memory is currently empty.": "A memória global está vazia no momento.",
  "Global memory content:\n\n---\n{{content}}\n---":
    "Conteúdo da memória global:\n\n---\n{{content}}\n---",
  "Project memory content from {{path}}:\n\n---\n{{content}}\n---":
    "Conteúdo da memória do projeto de {{path}}:\n\n---\n{{content}}\n---",
  "Project memory is currently empty.": "A memória do projeto está vazia no momento.",
  "Refreshing memory from source files...": "Atualizando memória dos arquivos fonte...",
  ...
  "Could not retrieve tool registry.": "Não foi possível recuperar o registro de ferramentas.",
  "No MCP servers configured with OAuth authentication.":
    "Nenhum servidor MCP configurado com autenticação OAuth.",
  "MCP servers with OAuth authentication:": "Servidores MCP com autenticação OAuth:",
  ...
  "Note: Newest last, oldest first": "Nota: Mais novos por último, mais antigos primeiro",
  ...
  "Set fast model for background tasks": "Definir modelo rápido para tarefas em segundo plano",
  ...
  "Starting a new session and clearing.": "Iniciando uma nova sessão e limpando.",
  ...
  "Failed to compress chat history: {{error}}": "Falha ao comprimir histórico do chat: {{error}}",
  ...
  "Chat history is already compressed.": "O histórico do chat já está comprimido.",

  // ============================================================================
  // Commands - Directory
  // ============================================================================
  "Configuration is not available.": "A configuração não está disponível.",
  "Please provide at least one path to add.": "Forneça pelo menos um caminho para adicionar.",
  ...
  "↑↓ to navigate · Enter to select · Esc to close": "↑↓ navegar · Enter selecionar · Esc fechar",
  "↑↓ to navigate · Enter to select · Esc to back": "↑↓ navegar · Enter selecionar · Esc voltar",
  "↑↓ to navigate · Enter to confirm · Esc to back": "↑↓ navegar · Enter confirmar · Esc voltar",
  "User Settings (global)": "Configurações do usuário (global)",
  "Workspace Settings (project-specific)": "Configurações do workspace (específico do projeto)",
  "Disable server:": "Desativar servidor:",
  ...
  // MCP Tool List
  "No tools available for this server.": "Nenhuma ferramenta disponível para este servidor.",
  ...
  "Allow execution of: '{{command}}'?": "Permitir a execução de: '{{command}}'?",
  "Yes, allow always ...": "Sim, permitir sempre ...",
  ...
  "Always allow {{action}} for this user": "Sempre permitir {{action}} para este usuário",
  ...
  "Change auth (executes the /auth command)": "Alterar autenticação (executa o comando /auth)",
  ...
  "Choose how to proceed with your session:": "Escolha como proceder com sua sessão:",
  ...
  "Terms of Services and Privacy Notice": "Termos de Serviço e Aviso de Privacidade",
  ...
  "Authentication timed out. Please try again.": "A autenticação expirou. Tente novamente.",
  ...
  "Invalid auth method selected.": "Método de autenticação inválido selecionado.",
  ...
  "Invalid credentials: {{errorMessage}}": "Credenciais inválidas: {{errorMessage}}",
  ...
  // Dialogs - Permissions
  // ============================================================================
  "Manage folder trust settings": "Gerenciar configurações de confiança de pasta",
  ...
  "This directory is already in the workspace.": "Este diretório já está na área de trabalho.",
  "Already covered by existing directory: {{dir}}": "Já coberto pelo diretório existente: {{dir}}",
  ...
  "💡 Tips:": "💡 Dicas:",
  Use: "Use",
  "to show server and tool descriptions": "para mostrar descrições de servidores e ferramentas",
  "to show tool parameter schemas": "para mostrar esquemas de parâmetros de ferramentas",
  ...
  "Switch auth type quickly with /auth.": "Troque o tipo de autenticação rapidamente com /auth.",
  ...
  Tool: "Ferramenta",
  Output: "Saída",
  "No API calls have been made in this session.": "Nenhuma chamada de API foi feita nesta sessão.",
  ...
  // ============================================================================
  "Markdown file already exists: {{filename}}": "Arquivo Markdown já existe: {{filename}}",
  "TOML Command Format Deprecation Notice": "Aviso de Obsolescência do Formato de Comando TOML",
  ...
  "Markdown: YAML frontmatter + content": "Markdown: YAML frontmatter + conteúdo",
  ...
  // ============================================================================
  "Open extensions page in your browser": "Abrir página de extensões no seu navegador",
  "Unknown extensions source: {{source}}.": "Fonte de extensões desconhecida: {{source}}.",
  "Would open extensions page in your browser: {{url}} (skipped in test environment)":
    "Abriria a página de extensões no seu navegador: {{url}} (pulado no ambiente de teste)",
  "View available extensions at {{url}}": "Ver extensões disponíveis em {{url}}",
  ...
  "Select API-KEY configuration mode:": "Selecione o modo de configuração da API-KEY:",
  ...
  Skills: "Habilidades",
  Messages: "Mensagens",
  "Show context window usage breakdown.": "Exibe a divisão de uso da janela de contexto.",
  ...
  // ============================================================================
  "Please answer the following question(s):": "Por favor, responda à(s) seguinte(s) pergunta(s):",
  ...
  "User declined to answer the questions.": "O usuário recusou responder às perguntas.",
  "User has provided the following answers:": "O usuário forneceu as seguintes respostas:",
  "Failed to process user answers:": "Falha ao processar as respostas do usuário:",
  ...
  "Region for Coding Plan (china/global)": "Região para Coding Plan (china/global)",
  ...
  "Enter your Coding Plan API key: ": "Insira sua chave de API do Coding Plan: ",

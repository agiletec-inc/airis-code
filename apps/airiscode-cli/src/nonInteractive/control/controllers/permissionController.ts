...
export class PermissionController extends BaseController {
  ...
  protected async handleRequestPayload(
    ...
    switch (payload.subtype) {
      case "can_use_tool":
        return this.handleCanUseTool(payload as CLIControlPermissionRequest, signal);

      case "set_permission_mode":
        return this.handleSetPermissionMode(payload as CLIControlSetPermissionModeRequest, signal);
  ...
  private async handleSetPermissionMode(
    ...
    const validModes: PermissionMode[] = ["default", "plan", "auto-edit", "yolo"];
   ...
   */
  private async handleOutgoingPermissionRequest(toolCall: WaitingToolCall): Promise<void> {
    try {

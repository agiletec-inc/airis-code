...
export default {
  ...
  "All tools selected, including MCP tools": "Все инструменты выбраны, включая инструменты MCP",
  ...
  'Extension "{{name}}" uninstalled successfully.': 'Расширение "{{name}}" успешно удалено.',
  ...
  "Press Space, Enter, or Escape to dismiss": "Нажмите Пробел, Enter или Escape для закрытия",
  ...
  "Failed to save approval mode: {{error}}": "Не удалось сохранить режим подтверждения: {{error}}",
  "Failed to change approval mode: {{error}}": "Не удалось изменить режим подтверждения: {{error}}",
  "Apply to current session only (temporary)": "Применить только к текущей сессии (временно)",
  "Persist for this project/workspace": "Сохранить для этого проекта/рабочего пространства",
  "Persist for this user on this machine": "Сохранить для этого пользователя на этой машине",
  ...
  // Команды - Память
  // ============================================================================
  "Commands for interacting with memory.": "Команды для взаимодействия с памятью",
  ...
  "Add content to project-level memory.": "Добавить содержимое в память уровня проекта.",
  ...
  "Global memory is currently empty.": "Глобальная память в настоящее время пуста.",
  "Global memory content:\n\n---\n{{content}}\n---":
    "Содержимое глобальной памяти:\n\n---\n{{content}}\n---",
  "Project memory content from {{path}}:\n\n---\n{{content}}\n---":
    "Содержимое памяти проекта из {{path}}:\n\n---\n{{content}}\n---",
  "Project memory is currently empty.": "Память проекта в настоящее время пуста.",
  "Refreshing memory from source files...": "Обновление памяти из исходных файлов...",
  ...
  "List configured MCP servers and tools": "Просмотр настроенных MCP-серверов и инструментов",
  ...
  "List saved conversation checkpoints": "Показать сохраненные точки восстановления диалога",
  "No saved conversation checkpoints found.":
    "Не найдено сохраненных точек восстановления диалога.",
  "List of saved conversations:": "Список сохраненных диалогов:",
  "Note: Newest last, oldest first": "Примечание: новые последними, старые первыми",
  "Save the current conversation as a checkpoint. Usage: /chat save <tag>":
    "Сохранить текущий диалог как точку восстановления. Использование: /chat save <тег>",
  "Missing tag. Usage: /chat save <tag>": "Отсутствует тег. Использование: /chat save <тег>",
  "Delete a conversation checkpoint. Usage: /chat delete <tag>":
    "Удалить точку восстановления диалога. Использование: /chat delete <тег>",
  "Missing tag. Usage: /chat delete <tag>": "Отсутствует тег. Использование: /chat delete <тег>",
  ...
  "Missing tag. Usage: /chat resume <tag>": "Отсутствует тег. Использование: /chat resume <тег>",
  ...
  // ============================================================================
  "Pro quota limit reached for {{model}}.": "Исчерпана квота подписки Pro для {{model}}.",
  "Change auth (executes the /auth command)": "Изменить авторизацию (выполняет команду /auth)",
  ...
  "API Key:": "Ключ API:",
  "Invalid credentials: {{errorMessage}}": "Неверные учетные данные: {{errorMessage}}",
  ...
  "2. Be specific for the best results.": "2. Будьте конкретны для лучших результатов.",
  ...
  "You can get your Coding Plan API key here": "Вы можете получить API-ключ Coding Plan здесь",
  ...
  Skills: "Навыки",
  Messages: "Сообщения",
  "Show context window usage breakdown.": "Показать разбивку использования контекстного окна.",
  ...
  "↑↓ to navigate · Enter to select · Esc to close": "↑↓ навигация · Enter выбрать · Esc закрыть",
  "↑↓ to navigate · Enter to select · Esc to back": "↑↓ навигация · Enter выбрать · Esc назад",
  "↑↓ to navigate · Enter to confirm · Esc to back": "↑↓ навигация · Enter подтвердить · Esc назад",
  ...
  // ============================================================================
  "Please answer the following question(s):": "Пожалуйста, ответьте на следующий(ие) вопрос(ы):",
  ...
  "User declined to answer the questions.": "Пользователь отказался отвечать на вопросы.",
  "User has provided the following answers:": "Пользователь предоставил следующие ответы:",
  "Failed to process user answers:": "Не удалось обработать ответы пользователя:",

...
export function buildPermissionCheckContext(
  ...
  let filePath = typeof toolParams["file_path"] === "string" ? toolParams["file_path"] : undefined;
...
export async function persistPermissionOutcome(
  ...
  const detailsRules = (confirmationDetails as unknown as Record<string, unknown>)?.[
    "permissionRules"
  ] as string[] | undefined;

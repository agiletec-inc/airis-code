...
vi.mock('../tools/memoryTool', () => ({
  ...
  getCurrentGeminiMdFilename: vi.fn(() => 'AIRISCODE.md'), // Mock the original filename
  getAllGeminiMdFilenames: vi.fn(() => ['AIRISCODE.md', 'AGENTS.md']),
  DEFAULT_CONTEXT_FILENAME: 'AIRISCODE.md',
  AIRISCODE_CONFIG_DIR: '.airiscode',
}));

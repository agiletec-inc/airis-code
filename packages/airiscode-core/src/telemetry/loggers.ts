...
export function logLoopDetected(_config: Config, _event: LoopDetectedEvent): void {
  return;
}
...
export function logUserFeedback(config: Config, event: UserFeedbackEvent): void {
  // Preserve the UI telemetry side effects since they are independent of OTel.
  const uiEvent = {
    ...event,
...
export function logArenaSessionStarted(_config: Config, _event: ArenaSessionStartedEvent): void {
  return;
}

export function logArenaAgentCompleted(_config: Config, _event: ArenaAgentCompletedEvent): void {
  return;
}

export function logArenaSessionEnded(_config: Config, _event: ArenaSessionEndedEvent): void {
  return;
}

export function logPromptSuggestion(_config: Config, _event: PromptSuggestionEvent): void {
  return;
}

export function logSpeculation(_config: Config, _event: SpeculationEvent): void {
  return;
}

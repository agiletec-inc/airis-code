...
export class FileDiscoveryService {
    ...
    filterFiles(filePaths, options = {
        ...
        return filePaths.filter((filePath) => {
            ...
            if (options.respectAiriscodeIgnore && this.shouldAiriscodeIgnoreFile(filePath)) {
                return false;
            }
            return true;
        });
    ...
    filterFilesWithReport(filePaths, opts = {
        ...
        for (const filePath of filePaths) {
            ...
            if (opts.respectAiriscodeIgnore && this.shouldAiriscodeIgnoreFile(filePath)) {
                qwenIgnoredCount++;
                continue;
            }
     ...
     */
    shouldAiriscodeIgnoreFile(filePath) {
    ...
    shouldIgnoreFile(filePath, options = {}) {
        const { respectGitIgnore = true, respectAiriscodeIgnore: respectAiriscodeIgnore = true, } = options;
        if (respectGitIgnore && this.shouldGitIgnoreFile(filePath)) {
            return true;
        }
        if (respectAiriscodeIgnore && this.shouldAiriscodeIgnoreFile(filePath)) {
            return true;
        }
        return false;
    }
    /**
     * Returns loaded patterns from .airiscodeigenore
     */

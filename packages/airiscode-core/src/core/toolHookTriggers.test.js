...
describe('toolHookTriggers', () => {
    ...
    describe('fireNotificationHook', () => {
        ...
        it('should send correct parameters to MessageBus for permission_prompt', async () => {
            ...
            await fireNotificationHook(mockMessageBus, 'AIRIS Code needs your permission to use Bash', NotificationType.PermissionPrompt, 'Permission needed');
            expect(mockMessageBus.request).toHaveBeenCalledWith({
                type: MessageBusType.HOOK_EXECUTION_REQUEST,
                eventName: 'Notification',
                input: {
                    message: 'AIRIS Code needs your permission to use Bash',
        ...
        it('should send correct parameters to MessageBus for idle_prompt', async () => {
            ...
            await fireNotificationHook(mockMessageBus, 'AIRIS Code is waiting for your input', NotificationType.IdlePrompt, 'Waiting for input');
            expect(mockMessageBus.request).toHaveBeenCalledWith({
                type: MessageBusType.HOOK_EXECUTION_REQUEST,
                eventName: 'Notification',
                input: {
                    message: 'AIRIS Code is waiting for your input',

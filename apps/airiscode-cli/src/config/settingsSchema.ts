  ...
  general: {
    ...
    properties: {
      ...
      gitCoAuthor: {
        ...
        default: true,
        description:
          "Automatically add a Co-authored-by trailer to git commit messages when commits are made through AIRIS Code.",
        showInDialog: true,
      },
      checkpointing: {
        type: "object",
      ...
      language: {
        ...
        description:
          ...
          "in ~/.airiscode/locales/ (e.g., ~/.airiscode/locales/es.js).",
        showInDialog: true,
  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        requiresRestart: false,
        default: false,
        description: "Show AIRIS Code status and thoughts in the terminal window title",
        showInDialog: false,
      },
      hideTips: {
        type: "boolean",
      ...
      generationConfig: {
        ...
        properties: {
          ...
          contextWindowSize: {
            ...
            default: undefined,
            description:
              "Overrides the default context window size for the selected model. Use this setting when a provider's effective context limit differs from AIRIS Code's default. This value defines the model's assumed maximum context capacity, not a per-request token limit.",
            parentKey: "generationConfig",
            showInDialog: false,
          },
        },
      ...
      fileFiltering: {
        ...
        properties: {
          ...
          respectAiriscodeIgnore: {
            type: "boolean",
            label: "Respect .airiscodeigenore",
            category: "Context",
            requiresRestart: true,
            default: true,
            description: "Respect .airiscodeigenore files when searching",
            showInDialog: true,
          },
      ...
      arena: {
        ...
        properties: {
          worktreeBaseDir: {
            ...
            default: undefined as string | undefined,
            description:
              "Custom base directory for Arena worktrees. Defaults to ~/.airiscode/arena.",
            showInDialog: false,
          },
          preserveArtifacts: {
            type: "boolean",

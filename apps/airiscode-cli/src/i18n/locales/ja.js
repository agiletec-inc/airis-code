...
export default {
  ...
  "Configure authentication information for login": "ログイン用の認証情報を設定",
  ...
  "Unknown step": "不明なステップ",
  "Esc to back": "Esc 戻る",
  "↑↓ to navigate · Enter to select · Esc to close": "↑↓ ナビゲート · Enter 選択 · Esc 閉じる",
  "↑↓ to navigate · Enter to select · Esc to back": "↑↓ ナビゲート · Enter 選択 · Esc 戻る",
  "↑↓ to navigate · Enter to confirm · Esc to back": "↑↓ ナビゲート · Enter 確認 · Esc 戻る",
  ...
  "Press Enter to start authentication, Esc to go back": "Enter で認証開始、Esc で戻る",
  ...
  "Tab to complete · Enter to add · Esc to cancel": "Tab で補完 · Enter で追加 · Esc でキャンセル",
  ...
  "You can get your Coding Plan API key here": "Coding Plan APIキーはこちらで取得できます",
  ...
  Skills: "スキル",
  Messages: "メッセージ",
  "Show context window usage breakdown.": "コンテキストウィンドウの使用状況を表示します。",
  ...
  "User declined to answer the questions.": "ユーザーは質問への回答を拒否しました。",
  "User has provided the following answers:": "ユーザーは以下の回答を提供しました：",
  ...
  "Enter your Coding Plan API key: ": "Coding Plan の API キーを入力してください: ",
  "Select authentication method:": "認証方法を選択:",

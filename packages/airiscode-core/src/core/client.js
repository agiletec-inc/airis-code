...
// Forked query cache
import { saveCacheSafeParams, clearCacheSafeParams, } from '../followup/forkedQuery.js';
// Utilities
        ...
        if (messageType === SendMessageType.UserQuery ||
            ...
            if (!this.thinkingClearLatched &&
                ...
                if (idleMs > thresholdMs) {
                    ...
                    debugLogger.debug(`Thinking clear latched: idle ${Math.round(idleMs / 1000)}s > threshold ${thresholdMs / 1000}s`);
                }
            }
            if (this.thinkingClearLatched) {

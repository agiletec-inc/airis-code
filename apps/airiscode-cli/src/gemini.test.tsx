...
describe('gemini.tsx main function', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvGeminiSandbox = process.env['AIRISCODE_SANDBOX'];
    originalEnvSandbox = process.env['SANDBOX'];
    delete process.env['AIRISCODE_SANDBOX'];
  ...
  afterEach(() => {
    ...
    if (originalEnvGeminiSandbox !== undefined) {
      process.env['AIRISCODE_SANDBOX'] = originalEnvGeminiSandbox;
    } else {
      delete process.env['AIRISCODE_SANDBOX'];
    }
...
describe('gemini.tsx main function kitty protocol', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvNoRelaunch = process.env['AIRISCODE_NO_RELAUNCH'];
    process.env['AIRISCODE_NO_RELAUNCH'] = 'true';
  ...
  afterEach(() => {
    ...
    if (originalEnvNoRelaunch !== undefined) {
      process.env['AIRISCODE_NO_RELAUNCH'] = originalEnvNoRelaunch;
    } else {
      delete process.env['AIRISCODE_NO_RELAUNCH'];
    }
  });

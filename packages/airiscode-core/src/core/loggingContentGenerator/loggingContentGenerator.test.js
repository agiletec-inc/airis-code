...
const realConvertGeminiRequestToOpenAI = OpenAIContentConverter.prototype.convertGeminiRequestToOpenAI;
...
const setModalitiesSpy = vi.spyOn(OpenAIContentConverter.prototype, 'setModalities');
...
describe('LoggingContentGenerator', () => {
    ...
    it('uses generator modalities when converting logged OpenAI requests', async () => {
        convertGeminiRequestToOpenAISpy.mockImplementationOnce(function (request, options) {

...
const memoryToolSchemaData = {
    ...
    parametersJsonSchema: {
        ...
        properties: {
            ...
            scope: {
                type: 'string',
                description: 'Where to save the memory: "global" saves to user-level ~/.airiscode/AIRISCODE.md (shared across all projects), "project" saves to current project\'s AIRISCODE.md (project-specific). If not specified, will prompt user to choose.',
                enum: ['global', 'project'],
            },
        },
        required: ['fact'],
...
- \`scope\` (string, optional): Where to save the memory:
  - "global": Saves to user-level ~/.airiscode/AIRISCODE.md (shared across all projects)
  - "project": Saves to current project's AIRISCODE.md (project-specific)

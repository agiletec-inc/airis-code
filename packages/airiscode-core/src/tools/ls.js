    ...
    async execute(_signal) {
        try {
            ...
            const { filteredPaths, gitIgnoredCount, qwenIgnoredCount } = fileDiscovery.filterFilesWithReport(relativePaths, {
                ...
                respectAiriscodeIgnore: this.params.file_filtering_options?.respect_airiscode_ignore ??
        ...
        super(LSTool.Name, ToolDisplayNames.LS, 'Lists the names of files and subdirectories directly within a specified directory path. Can optionally ignore entries matching provided glob patterns.', Kind.Search, {
            properties: {
                ...
                file_filtering_options: {
                    description: 'Optional: Whether to respect ignore patterns from .gitignore or .airiscodeigenore',
                    type: 'object',
                    properties: {
                        respect_git_ignore: {
                        ...
                        respect_airiscode_ignore: {
                            description: 'Optional: Whether to respect .airiscodeigenore patterns when listing files. Defaults to true.',
                            type: 'boolean',
                        },
                    },
                },

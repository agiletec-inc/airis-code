...
3. **Architect Comprehensive Instructions**: Develop a system prompt that:
   ...
   - Aligns with project-specific coding standards and patterns from AIRISCODE.md
...
export async function subagentGenerator(userDescription, config, abortSignal) {
    ...
    const parsedResponse = (await config.getBaseLlmClient().generateJson({
        model: config.getModel() || DEFAULT_AIRISCODE_MODEL,
        contents,

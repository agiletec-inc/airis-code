...
describe('SkillManager', () => {
    ...
    const validSkillConfig = {
        ...
        description: 'A test skill',
        level: 'project',
        filePath: '/test/project/.airiscode/skills/test-skill/SKILL.md',
...
`;
        ...
        it('should determine level from file path', () => {
            const projectPath = '/test/project/.airiscode/skills/test-skill/SKILL.md';
            const userPath = '/home/user/.airiscode/skills/test-skill/SKILL.md';
...
`;
    ...
    describe('listSkills', () => {
        beforeEach(() => {
            ...
            const projectQwenSkillsDir = path.join('/test/project', '.airiscode', 'skills');
            const userQwenSkillsDir = path.join('/home/user', '.airiscode', 'skills');
...
Skill 3 content`);
        ...
        it('should deduplicate same-name skills across provider dirs within a level', async () => {
            ...
            const projectQwenDir = path.join('/test/project', '.airiscode', 'skills');
            ...
            vi.mocked(fs.readFile).mockImplementation((filePath) => {
                const pathStr = String(filePath);
                if (pathStr.includes('.airiscode') && pathStr.includes('shared-skill')) {
    ...
    describe('getSkillsBaseDirs', () => {
        it('should return all project-level base dirs', () => {
            ...
            expect(baseDirs).toContain(path.join('/test/project', '.airiscode', 'skills'));
        ...
        it('should return all user-level base dirs', () => {
            ...
            expect(baseDirs).toHaveLength(2);
            expect(baseDirs).toContain(path.join('/home/user', '.airiscode', 'skills'));
    ...
    describe('bundled skills', () => {
        ...
        const projectDirSegment = path.join('.airiscode', 'skills');
        const userDirSegment = path.join('.airiscode', 'skills');
        ...
        function mockReaddirForLevels(levels) {
            vi.mocked(fs.readdir).mockImplementation((dirPath) => {
                const pathStr = String(dirPath);
                const isBundled = pathStr.endsWith(bundledDirSegment) && !pathStr.includes('.airiscode');

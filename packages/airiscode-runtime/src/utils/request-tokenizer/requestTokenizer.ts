...
import type { Content, CountTokensParameters, Part, PartUnion } from "../../types/llm.js";
...
export class RequestTokenizer {
   ...
   */
  async calculateTokens(request: CountTokensParameters): Promise<TokenCalculationResult> {

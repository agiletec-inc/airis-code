...
export default {
  ...
  'Failed to update extension "{{name}}": {{error}}': '更新扩展 "{{name}}" 失败：{{error}}',
  ...
  "Usage: /extensions update <extension-names>|--all": "用法：/extensions update <扩展名>|--all",
  ...
  "Usage: /extensions uninstall <extension-name>": "用法：/extensions uninstall <扩展名>",
  'Uninstalling extension "{{name}}"...': '正在卸载扩展 "{{name}}"...',
  'Extension "{{name}}" uninstalled successfully.': '扩展 "{{name}}" 卸载成功。',
  'Failed to uninstall extension "{{name}}": {{error}}': '卸载扩展 "{{name}}" 失败：{{error}}',
  ...
  "This extension will run the following MCP servers:": "此扩展将运行以下 MCP 服务器：",
  local: "本地",
  remote: "远程",
  ...
  "Scope subcommands do not accept additional arguments.": "作用域子命令不接受额外参数",
  "Plan mode - Analyze only, do not modify files or execute commands":
    "规划模式 - 仅分析，不修改文件或执行命令",
  "Default mode - Require approval for file edits or shell commands":
    "默认模式 - 需要批准文件编辑或 shell 命令",
  "Auto-edit mode - Automatically approve file edits": "自动编辑模式 - 自动批准文件编辑",
  ...
  "Usage: /memory add --project <text to remember>": "用法：/memory add --project <要记住的文本>",
  "Usage: /memory add --global <text to remember>": "用法：/memory add --global <要记住的文本>",
  'Attempting to save to project memory: "{{text}}"': '正在尝试保存到项目记忆："{{text}}"',
  'Attempting to save to global memory: "{{text}}"': '正在尝试保存到全局记忆："{{text}}"',
  "Current memory content from {{count}} file(s):": "来自 {{count}} 个文件的当前记忆内容：",
  "Memory is currently empty.": "记忆当前为空",
  "Project memory file not found or is currently empty.": "项目记忆文件未找到或当前为空",
  "Global memory file not found or is currently empty.": "全局记忆文件未找到或当前为空",
  ...
  'Attempting to save to memory {{scope}}: "{{fact}}"': '正在尝试保存到记忆 {{scope}}："{{fact}}"',

  // ============================================================================
  // Commands - MCP
  // ============================================================================
  "Authenticate with an OAuth-enabled MCP server": "使用支持 OAuth 的 MCP 服务器进行认证",
  ...
  "No MCP servers configured with OAuth authentication.": "未配置支持 OAuth 认证的 MCP 服务器",
  "MCP servers with OAuth authentication:": "支持 OAuth 认证的 MCP 服务器：",
  "Use /mcp auth <server-name> to authenticate.": "使用 /mcp auth <server-name> 进行认证",
  ...
  "Unknown step": "未知步骤",
  "Esc to back": "Esc 返回",
  "↑↓ to navigate · Enter to select · Esc to close": "↑↓ 导航 · Enter 选择 · Esc 关闭",
  "↑↓ to navigate · Enter to select · Esc to back": "↑↓ 导航 · Enter 选择 · Esc 返回",
  "↑↓ to navigate · Enter to confirm · Esc to back": "↑↓ 导航 · Enter 确认 · Esc 返回",
  ...
  server: "个服务器",
  servers: "个服务器",
  "Add MCP servers to your settings to get started.": "请在设置中添加 MCP 服务器以开始使用。",
  "Run qwen --debug to see error logs": "运行 qwen --debug 查看错误日志",

  // MCP OAuth Authentication
  "OAuth Authentication": "OAuth 认证",
  "Press Enter to start authentication, Esc to go back": "按 Enter 开始认证，Esc 返回",
  ...
  "Missing tag. Usage: /chat delete <tag>": "缺少标签。用法：/chat delete <tag>",
  "Conversation checkpoint '{{tag}}' has been deleted.": "对话检查点 '{{tag}}' 已删除",
  "Error: No checkpoint found with tag '{{tag}}'.": "错误：未找到标签为 '{{tag}}' 的检查点",
  "Resume a conversation from a checkpoint. Usage: /chat resume <tag>":
    "从检查点恢复对话。用法：/chat resume <tag>",
  "Missing tag. Usage: /chat resume <tag>": "缺少标签。用法：/chat resume <tag>",
  "No saved checkpoint found with tag: {{tag}}.": "未找到标签为 {{tag}} 的已保存检查点",
  "A checkpoint with the tag {{tag}} already exists. Do you want to overwrite it?":
    "标签为 {{tag}} 的检查点已存在。您要覆盖它吗？",
  "No chat client available to save conversation.": "没有可用的聊天客户端来保存对话",
  "Conversation checkpoint saved with tag: {{tag}}.": "对话检查点已保存，标签：{{tag}}",
  "No conversation found to save.": "未找到要保存的对话",
  "No chat client available to share conversation.": "没有可用的聊天客户端来分享对话",
  ...
  "{{envKeyHint}} environment variable not found.": "未找到 {{envKeyHint}} 环境变量。",
  ...
  "Are you sure you want to delete this permission rule?": "确定要删除此权限规则吗？",
  "Permissions:": "权限：",
  ...
  "Tab to complete · Enter to add · Esc to cancel": "Tab 补全 · 回车添加 · Esc 取消",
  ...
  "↑/↓: Navigate | Space/Enter: Toggle | Esc: Cancel": "↑/↓: 导航 | Space/Enter: 切换 | Esc: 取消",

...
export class SubagentManager {
    ...
    async createAgentHeadless(config, runtimeContext, options) {
        try {
            ...
            return await AgentHeadless.create(config.name, agentContext, runtimeConfig.promptConfig, runtimeConfig.modelConfig, runtimeConfig.runConfig, runtimeConfig.toolConfig, options?.eventEmitter, options?.hooks);
        }
        catch (error) {

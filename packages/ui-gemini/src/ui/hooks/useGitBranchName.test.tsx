...
import { spawnAsync as mockSpawnAsync } from "@airiscode/gemini-cli-core";
...
// Mock @airiscode/gemini-cli-core
vi.mock("@airiscode/gemini-cli-core", async () => {
  const original = await vi.importActual<typeof import("@airiscode/gemini-cli-core")>(
    "@airiscode/gemini-cli-core",
  );
  return {
    ...original,
    spawnAsync: vi.fn(),

...
declare const TOOL_CALL_COUNT = "airiscode.tool.call.count";
declare const API_REQUEST_COUNT = "airiscode.api.request.count";
declare const TOKEN_USAGE = "airiscode.token.usage";
declare const FILE_OPERATION_COUNT = "airiscode.file.operation.count";
export declare const SUBAGENT_EXECUTION_COUNT = "airiscode.subagent.execution.count";
declare const STARTUP_TIME = "airiscode.startup.duration";
declare const MEMORY_USAGE = "airiscode.memory.usage";
declare const CPU_USAGE = "airiscode.cpu.usage";
declare const TOOL_EXECUTION_BREAKDOWN = "airiscode.tool.execution.breakdown";
declare const TOKEN_EFFICIENCY = "airiscode.token.efficiency";
declare const API_REQUEST_BREAKDOWN = "airiscode.api.request.breakdown";
declare const PERFORMANCE_SCORE = "airiscode.performance.score";
declare const REGRESSION_DETECTION = "airiscode.performance.regression";
declare const BASELINE_COMPARISON = "airiscode.performance.baseline.comparison";
declare const COUNTER_DEFINITIONS: {
    readonly "airiscode.tool.call.count": {
    ...
    readonly "airiscode.api.request.count": {
    ...
    readonly "airiscode.token.usage": {
    ...
    readonly "airiscode.chat_compression": {
...
declare const HISTOGRAM_DEFINITIONS: {
    readonly "airiscode.tool.call.latency": {
    ...
    readonly "airiscode.api.request.latency": {
...
declare const PERFORMANCE_COUNTER_DEFINITIONS: {
    readonly "airiscode.performance.regression": {
...
declare const PERFORMANCE_HISTOGRAM_DEFINITIONS: {
    readonly "airiscode.startup.duration": {
    ...
    readonly "airiscode.memory.usage": {
    ...
    readonly "airiscode.tool.queue.depth": {
    ...
    readonly "airiscode.tool.execution.breakdown": {
    ...
    readonly "airiscode.token.efficiency": {
    ...
    readonly "airiscode.api.request.breakdown": {
    ...
    readonly "airiscode.performance.score": {
    ...
    readonly "airiscode.performance.regression.percentage_change": {
    ...
    readonly "airiscode.performance.baseline.comparison": {

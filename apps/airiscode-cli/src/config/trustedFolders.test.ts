...
import { FatalConfigError, ideContextStore } from '@airiscode/core';
import {
  describe,
  it,
  expect,
...
describe('Trusted Folders Loading', () => {
  ...
  it('should use AIRISCODE_TRUSTED_FOLDERS_PATH env var if set', () => {
    const customPath = '/custom/path/to/trusted_folders.json';
    process.env['AIRISCODE_TRUSTED_FOLDERS_PATH'] = customPath;
    ...
    delete process.env['AIRISCODE_TRUSTED_FOLDERS_PATH'];
  });

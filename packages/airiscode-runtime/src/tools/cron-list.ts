...
class CronListInvocation extends BaseToolInvocation<CronListParams, ToolResult> {
  constructor(
...
export class CronListTool extends BaseDeclarativeTool<CronListParams, ToolResult> {

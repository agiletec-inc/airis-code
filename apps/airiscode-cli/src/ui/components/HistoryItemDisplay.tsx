...
import { getMCPServerStatus } from "@airiscode/runtime";
...
const HistoryItemDisplayComponent: React.FC<HistoryItemDisplayProps> = ({
  ...
  const marginTop =
    item.type === "gemini_content" || item.type === "gemini_thought_content" ? 0 : 1;
  ...
  return (
    ...
    >
      ...
      {itemForDisplay.type === "user" && <UserMessage text={itemForDisplay.text} />}
      ...
      {itemForDisplay.type === "info" && <InfoMessage text={itemForDisplay.text} />}
      {itemForDisplay.type === "success" && <SuccessMessage text={itemForDisplay.text} />}
      ...
      {itemForDisplay.type === "help" && commands && <Help commands={commands} width={boxWidth} />}
      {itemForDisplay.type === "stats" && (
        <StatsDisplay duration={itemForDisplay.duration} width={boxWidth} />
      )}
      {itemForDisplay.type === "model_stats" && <ModelStatsDisplay width={boxWidth} />}
      {itemForDisplay.type === "tool_stats" && <ToolStatsDisplay width={boxWidth} />}
      {itemForDisplay.type === "quit" && (
        <SessionSummaryDisplay duration={itemForDisplay.duration} width={boxWidth} />
      )}
      ...
      {itemForDisplay.type === "summary" && <SummaryMessage summary={itemForDisplay.summary} />}
      ...
      {itemForDisplay.type === "skills_list" && <SkillsList skills={itemForDisplay.skills} />}

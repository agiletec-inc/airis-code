...
export default {
  ...
  "← → select, Delete to remove, ↓ to exit": "← → auswählen, Entf zum Löschen, ↓ beenden",
  "Attachments: ": "Anhänge: ",
  ...
  "Description is over {{length}} characters": "Beschreibung ist über {{length}} Zeichen",
  "System prompt is over {{length}} characters": "System-Prompt ist über {{length}} Zeichen",
  // Agents - Creation Wizard Steps
  "Step {{n}}: Choose Location": "Schritt {{n}}: Speicherort wählen",
  "Step {{n}}: Choose Generation Method": "Schritt {{n}}: Generierungsmethode wählen",
  ...
  "e.g., You are an expert code reviewer...": "z.B. Sie sind ein Experte für Code-Reviews...",
  ...
  'Uninstalling extension "{{name}}"...': 'Deinstalliere Erweiterung "{{name}}"...',
  ...
  "Link extension failed to install.": "Verknüpfte Erweiterung konnte nicht installiert werden.",
  ...
  // ============================================================================
  "No plugins available in this marketplace.": "In diesem Marktplatz sind keine Plugins verfügbar.",
  ...
  "Press Space, Enter, or Escape to dismiss": "Leertaste, Enter oder Escape zum Schließen",
  ...
  "No hooks configured for this event.": "Für dieses Ereignis sind keine Hooks konfiguriert.",
  ...
  "Configured Hooks ({{count}} total)": "Konfigurierte Hooks ({{count}} insgesamt)",
  ...
  // Commands - Language
  // ============================================================================
  "Invalid language. Available: {{options}}": "Ungültige Sprache. Verfügbar: {{options}}",
  ...
  "Example: /language output Português": "Beispiel: /language output Portugiesisch",
  ...
  "Invalid command. Available subcommands:": "Ungültiger Befehl. Verfügbare Unterbefehle:",
  ...
  "Apply to current session only (temporary)": "Nur auf aktuelle Sitzung anwenden (temporär)",
  "Persist for this project/workspace": "Für dieses Projekt/Arbeitsbereich speichern",
  "Persist for this user on this machine": "Für diesen Benutzer auf diesem Computer speichern",
  ...
  // Commands - Memory
  // ============================================================================
  "Commands for interacting with memory.": "Befehle für die Interaktion mit dem Speicher.",
  ...
  "Add content to project-level memory.": "Inhalt zum Projektebene-Speicher hinzufügen.",
  ...
  "No saved conversation checkpoints found.": "Keine gespeicherten Gesprächsprüfpunkte gefunden.",
  ...
  "Error sharing conversation: {{error}}": "Fehler beim Teilen des Gesprächs: {{error}}",
  ...
  "Set fast model for background tasks": "Schnelles Modell für Hintergrundaufgaben festlegen",
  ...
  "Starting a new session and clearing.": "Neue Sitzung wird gestartet und gelöscht.",
  ...
  "↑↓ to navigate · Enter to select · Esc to back": "↑↓ navigieren · Enter auswählen · Esc zurück",
  ...
  "Press Enter to confirm, Esc to cancel": "Enter zum Bestätigen, Esc zum Abbrechen",
  ...
  // MCP Tool List
  "No tools available for this server.": "Keine Werkzeuge für diesen Server verfügbar.",
  ...
  "Always allow {{action}} for this user": "{{action}} für diesen Benutzer immer erlauben",
  ...
  // Dialogs - Pro Quota
  // ============================================================================
  "Pro quota limit reached for {{model}}.": "Pro-Kontingentlimit für {{model}} erreicht.",
  ...
  "Invalid auth method selected.": "Ungültige Authentifizierungsmethode ausgewählt.",
  ...
  "Invalid credentials: {{errorMessage}}": "Ungültige Anmeldedaten: {{errorMessage}}",
  ...
  "Saved in .qwen/settings.local.json": "Gespeichert in .qwen/settings.local.json",
  ...
  "2. Be specific for the best results.": "2. Seien Sie spezifisch für die besten Ergebnisse.",
  ...
  "Press Enter to submit, Escape to cancel": "Enter zum Absenden, Escape zum Abbrechen drücken",
  ...
  "View available extensions at {{url}}": "Verfügbare Erweiterungen ansehen unter {{url}}",
  ...
  "Select API-KEY configuration mode:": "API-KEY-Konfigurationsmodus auswählen:",
  ...
  "Estimated pre-conversation overhead": "Geschätzte Vorabkosten vor der Unterhaltung",
  "Context window": "Kontextfenster",
  tokens: "Tokens",
  Used: "Verwendet",
  Free: "Frei",
  ...
  // ============================================================================
  "Please answer the following question(s):": "Bitte beantworten Sie die folgende(n) Frage(n):",
  ...
  "User declined to answer the questions.": "Benutzer hat die Beantwortung der Fragen abgelehnt.",
  "User has provided the following answers:":
    "Benutzer hat die folgenden Antworten bereitgestellt:",
  "Failed to process user answers:": "Fehler beim Verarbeiten der Benutzerantworten:",
  ...
  "Region for Coding Plan (china/global)": "Region für Coding Plan (china/global)",
  ...
  "Select region for Coding Plan:": "Region für Coding Plan auswählen:",
  "Enter your Coding Plan API key: ": "Geben Sie Ihren Coding Plan API-Schlüssel ein: ",
  "Select authentication method:": "Authentifizierungsmethode auswählen:",
  ...
  "Press Ctrl+O to show full tool output": "Strg+O für vollständige Tool-Ausgabe drücken",

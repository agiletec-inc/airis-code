...
describe('QwenIgnoreParser', () => {
    ...
    describe('when .airiscodeigenore exists', () => {
        beforeEach(async () => {
            await createTestFile('.airiscodeigenore', 'ignored.txt\n# A comment\n/ignored_dir/\n');
        ...
        it('should ignore files specified in .airiscodeigenore', () => {
    ...
    describe('when .airiscodeigenore does not exist', () => {

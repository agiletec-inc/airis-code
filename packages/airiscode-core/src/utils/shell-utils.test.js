...
import { checkArgumentSafety, checkCommandPermissions, escapeShellArg, getCommandRoots, getShellConfiguration, isCommandAllowed, isCommandNeedsPermission, stripShellWrapper, } from './shell-utils.js';
...
describe('getCommandRoots', () => {
    ...
    it('should skip leading env var assignments', async () => {
        expect(getCommandRoots('PYTHONPATH=/Users/jinjing/.airiscode/skills/scripts python3 -c "print(1)"')).toEqual(['python3']);
    });

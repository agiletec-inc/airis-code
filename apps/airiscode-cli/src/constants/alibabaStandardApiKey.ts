...
export type AlibabaStandardRegion = "cn-beijing" | "sg-singapore" | "us-virginia" | "cn-hongkong";

export const DASHSCOPE_STANDARD_API_KEY_ENV_KEY = "DASHSCOPE_API_KEY";

export const ALIBABA_STANDARD_API_KEY_ENDPOINTS: Record<AlibabaStandardRegion, string> = {

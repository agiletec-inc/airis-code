    ...
    describe('buildHeaders', () => {
        it('should build DashScope-specific headers', () => {
            ...
            expect(headers).toEqual({
                ...
                'X-DashScope-UserAgent': `AirisCode/1.0.0 (${process.platform}; ${process.arch})`,
        ...
        it('should merge custom headers with DashScope defaults', () => {
            ...
            expect(headers['User-Agent']).toContain('AirisCode/1.0.0');
            expect(headers['X-DashScope-UserAgent']).toContain('AirisCode/1.0.0');
        ...
        it('should handle unknown CLI version', () => {
            ...
            expect(headers['X-DashScope-UserAgent']).toBe(`AirisCode/unknown (${process.platform}; ${process.arch})`);
        });
    });

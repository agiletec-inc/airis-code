...
function getInitialTrustState(settings: LoadedSettings, cwd: string): TrustState {
...
export const useTrustModify = (onExit: () => void, addItem: UseHistoryManagerReturn["addItem"]) => {
